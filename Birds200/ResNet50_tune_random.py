...
EPOCHS = 1
RESULTS_PATH = os.path.join("AutoConv_ResNet50", "AutoFCL_AutoConv_ResNet50_randomsearch_log_" + DATA_FOLDER.split('/')[-1] + "_autoconv_bayes_opt_v1.csv") # The path to the results file
