...
RESULTS_PATH = os.path.join("AutoFC_VGG16", "AutoFC_VGG16_log_" + DATA_FOLDER + "_bayes_opt_v5.csv") # The path to the results file
...
p_space = {
    ...
    'num_layers': list(range(0,2)) # the possible number of layers that can be used in the model
}
