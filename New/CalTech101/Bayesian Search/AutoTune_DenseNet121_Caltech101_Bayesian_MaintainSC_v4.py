...
EPOCHS = 1
RESULTS_PATH = os.path.join("AutoConv_DenseNet121_new", "AutoConv_DenseNet121_log_" + DATA_FOLDER.split('/')[-1] + "_autoconv_bayes_opt_v1.csv") # The path to the results file
