...
EPOCHS = 50
RESULTS_PATH = os.path.join("AutoConv_ResNet50_new2", "AutoConv_ResNet50_randomsearch_log_" + DATA_FOLDER.split('/')[-1] + "_autoconv_v10.csv") # The path to the results file
