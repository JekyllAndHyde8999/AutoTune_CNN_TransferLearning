...
EPOCHS = 50
RESULTS_PATH = os.path.join("AutoConv_ResNet50_new1", "upsampling_AutoConv_ResNet50_log_" + DATA_FOLDER.split('/')[-1] + "_autoconv_bayes_opt_UPS_v1.csv") # The path to the results file
