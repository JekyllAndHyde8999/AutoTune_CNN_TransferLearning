...
RESULTS_PATH = os.path.join("AutoFC_MobileNet", "AutoFC_MobileNet_log_" + DATA_FOLDER + "_bayes_opt_v1.csv") # The path to the results file
...
for combo in p_space:
    ...
    def model_fit(x):
        ...
        history = model.fit_generator(train_generator,
            validation_data=valid_generator, epochs=40, callbacks=[lr_reducer],
