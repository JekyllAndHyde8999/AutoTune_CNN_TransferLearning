...
RESULTS_PATH = os.path.join("AutoFC_NASNet", "AutoFC_NASNet_log_" + DATA_FOLDER + "_bayes_opt_v1.csv") # The path to the results file
...
def get_model(num_layers, num_neurons, dropout, activation, weight_initializer):
    base_model = NASNetMobile(weights="imagenet") # make an instance of an existing architecture
