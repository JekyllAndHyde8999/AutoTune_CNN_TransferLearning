...
RESULTS_PATH = os.path.join("AutoFC_MobileNet", "AutoFC_MobileNet_log_ucm-land_bayes_opt_v1.csv") # The path to the results file
...
def get_model(num_layers, num_neurons, dropout, activation, weight_initializer):
    base_model = MobileNet(weights="imagenet") # make an instance of an existing architecture
